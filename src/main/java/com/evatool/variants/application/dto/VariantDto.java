...
public class VariantDto {
    ...
    @ApiModelProperty(example = "{id: 'f33c6fa8-1697-11ea-8d71-362b9e155667', guiId: VAR2, title: 'Admin Contact', description: 'ILA is administered by a contact person', subVariant: [], analysisId:f33c6fa8-1697-11ea-8d71-362b9e155667, archived: false}")
