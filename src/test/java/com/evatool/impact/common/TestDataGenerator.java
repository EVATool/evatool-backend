...
public class TestDataGenerator {
    ...
    public static ImpactValue createDummyValue() {
        return new ImpactValue(UUID.randomUUID(),"dummyValue", ImpactValueType.ECONOMIC, "dummyValueDescription", createDummyAnalysis());
    }

    public static ImpactValue createDummyValue(ImpactAnalysis analysis) {
        return new ImpactValue(UUID.randomUUID(),"dummyValue", ImpactValueType.ECONOMIC, "dummyValueDescription", analysis);
    }
